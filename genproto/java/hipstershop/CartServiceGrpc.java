...
public final class CartServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<hipstershop.Cart.AddItemRequest,
      hipstershop.Demo.Empty> getAddItemMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "AddItem",
      requestType = hipstershop.Cart.AddItemRequest.class,
      responseType = hipstershop.Demo.Empty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<hipstershop.Cart.AddItemRequest,
      hipstershop.Demo.Empty> getAddItemMethod() {
    io.grpc.MethodDescriptor<hipstershop.Cart.AddItemRequest, hipstershop.Demo.Empty> getAddItemMethod;
      ...
      synchronized (CartServiceGrpc.class) {
        if ((getAddItemMethod = CartServiceGrpc.getAddItemMethod) == null) {
          CartServiceGrpc.getAddItemMethod = getAddItemMethod =
              io.grpc.MethodDescriptor.<hipstershop.Cart.AddItemRequest, hipstershop.Demo.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "AddItem"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  hipstershop.Cart.AddItemRequest.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<hipstershop.Cart.GetCartRequest,
      hipstershop.Demo.Cart> getGetCartMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetCart",
      requestType = hipstershop.Cart.GetCartRequest.class,
      responseType = hipstershop.Demo.Cart.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<hipstershop.Cart.GetCartRequest,
      hipstershop.Demo.Cart> getGetCartMethod() {
    io.grpc.MethodDescriptor<hipstershop.Cart.GetCartRequest, hipstershop.Demo.Cart> getGetCartMethod;
    if ((getGetCartMethod = CartServiceGrpc.getGetCartMethod) == null) {
      synchronized (CartServiceGrpc.class) {
        if ((getGetCartMethod = CartServiceGrpc.getGetCartMethod) == null) {
          CartServiceGrpc.getGetCartMethod = getGetCartMethod =
              io.grpc.MethodDescriptor.<hipstershop.Cart.GetCartRequest, hipstershop.Demo.Cart>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetCart"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  hipstershop.Cart.GetCartRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  private static volatile io.grpc.MethodDescriptor<hipstershop.Cart.EmptyCartRequest,
      hipstershop.Demo.Empty> getEmptyCartMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "EmptyCart",
      requestType = hipstershop.Cart.EmptyCartRequest.class,
      responseType = hipstershop.Demo.Empty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<hipstershop.Cart.EmptyCartRequest,
      hipstershop.Demo.Empty> getEmptyCartMethod() {
    io.grpc.MethodDescriptor<hipstershop.Cart.EmptyCartRequest, hipstershop.Demo.Empty> getEmptyCartMethod;
    if ((getEmptyCartMethod = CartServiceGrpc.getEmptyCartMethod) == null) {
      synchronized (CartServiceGrpc.class) {
        if ((getEmptyCartMethod = CartServiceGrpc.getEmptyCartMethod) == null) {
          CartServiceGrpc.getEmptyCartMethod = getEmptyCartMethod =
              io.grpc.MethodDescriptor.<hipstershop.Cart.EmptyCartRequest, hipstershop.Demo.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "EmptyCart"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  hipstershop.Cart.EmptyCartRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  hipstershop.Demo.Empty.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void addItem(hipstershop.Cart.AddItemRequest request,
    ...
    /**
     */
    default void getCart(hipstershop.Cart.GetCartRequest request,
    ...
    /**
     */
    default void emptyCart(hipstershop.Cart.EmptyCartRequest request,
        io.grpc.stub.StreamObserver<hipstershop.Demo.Empty> responseObserver) {
  ...
  public static final class CartServiceStub
    ...
    /**
     */
    public void addItem(hipstershop.Cart.AddItemRequest request,
        io.grpc.stub.StreamObserver<hipstershop.Demo.Empty> responseObserver) {
    ...
    /**
     */
    public void getCart(hipstershop.Cart.GetCartRequest request,
        io.grpc.stub.StreamObserver<hipstershop.Demo.Cart> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
    ...
    /**
     */
    public void emptyCart(hipstershop.Cart.EmptyCartRequest request,
        io.grpc.stub.StreamObserver<hipstershop.Demo.Empty> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class CartServiceBlockingStub
    ...
    /**
     */
    public hipstershop.Demo.Empty addItem(hipstershop.Cart.AddItemRequest request) {
    ...
    /**
     */
    public hipstershop.Demo.Cart getCart(hipstershop.Cart.GetCartRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
    ...
    /**
     */
    public hipstershop.Demo.Empty emptyCart(hipstershop.Cart.EmptyCartRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class CartServiceFutureStub
    ...
    public com.google.common.util.concurrent.ListenableFuture<hipstershop.Demo.Empty> addItem(
        hipstershop.Cart.AddItemRequest request) {
    ...
    public com.google.common.util.concurrent.ListenableFuture<hipstershop.Demo.Cart> getCart(
        hipstershop.Cart.GetCartRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public com.google.common.util.concurrent.ListenableFuture<hipstershop.Demo.Empty> emptyCart(
        hipstershop.Cart.EmptyCartRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ADD_ITEM:
          serviceImpl.addItem((hipstershop.Cart.AddItemRequest) request,
              (io.grpc.stub.StreamObserver<hipstershop.Demo.Empty>) responseObserver);
          break;
        case METHODID_GET_CART:
          serviceImpl.getCart((hipstershop.Cart.GetCartRequest) request,
              (io.grpc.stub.StreamObserver<hipstershop.Demo.Cart>) responseObserver);
          break;
        case METHODID_EMPTY_CART:
          serviceImpl.emptyCart((hipstershop.Cart.EmptyCartRequest) request,
              (io.grpc.stub.StreamObserver<hipstershop.Demo.Empty>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              hipstershop.Cart.AddItemRequest,
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              hipstershop.Cart.GetCartRequest,
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              hipstershop.Cart.EmptyCartRequest,
              hipstershop.Demo.Empty>(
  ...
  private static abstract class CartServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return hipstershop.Cart.getDescriptor();
    }
