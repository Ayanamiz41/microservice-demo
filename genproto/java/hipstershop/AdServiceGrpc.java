...
public final class AdServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "hipstershop.AdService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<hipstershop.AdOuterClass.AdRequest,
      hipstershop.AdOuterClass.AdResponse> getGetAdsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetAds",
      requestType = hipstershop.AdOuterClass.AdRequest.class,
      responseType = hipstershop.AdOuterClass.AdResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<hipstershop.AdOuterClass.AdRequest,
      hipstershop.AdOuterClass.AdResponse> getGetAdsMethod() {
    io.grpc.MethodDescriptor<hipstershop.AdOuterClass.AdRequest, hipstershop.AdOuterClass.AdResponse> getGetAdsMethod;
      ...
      synchronized (AdServiceGrpc.class) {
        if ((getGetAdsMethod = AdServiceGrpc.getGetAdsMethod) == null) {
          AdServiceGrpc.getGetAdsMethod = getGetAdsMethod =
              io.grpc.MethodDescriptor.<hipstershop.AdOuterClass.AdRequest, hipstershop.AdOuterClass.AdResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetAds"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  hipstershop.AdOuterClass.AdRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  hipstershop.AdOuterClass.AdResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getAds(hipstershop.AdOuterClass.AdRequest request,
        io.grpc.stub.StreamObserver<hipstershop.AdOuterClass.AdResponse> responseObserver) {
  ...
  public static final class AdServiceStub
    ...
    /**
     */
    public void getAds(hipstershop.AdOuterClass.AdRequest request,
        io.grpc.stub.StreamObserver<hipstershop.AdOuterClass.AdResponse> responseObserver) {
  ...
  public static final class AdServiceBlockingStub
    ...
    /**
     */
    public hipstershop.AdOuterClass.AdResponse getAds(hipstershop.AdOuterClass.AdRequest request) {
  ...
  public static final class AdServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<hipstershop.AdOuterClass.AdResponse> getAds(
        hipstershop.AdOuterClass.AdRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_ADS:
          serviceImpl.getAds((hipstershop.AdOuterClass.AdRequest) request,
              (io.grpc.stub.StreamObserver<hipstershop.AdOuterClass.AdResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              hipstershop.AdOuterClass.AdRequest,
              hipstershop.AdOuterClass.AdResponse>(
  ...
  private static abstract class AdServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return hipstershop.AdOuterClass.getDescriptor();
    }
