...
public final class RecommendationServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<hipstershop.Recommendation.ListRecommendationsRequest,
      hipstershop.Recommendation.ListRecommendationsResponse> getListRecommendationsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ListRecommendations",
      requestType = hipstershop.Recommendation.ListRecommendationsRequest.class,
      responseType = hipstershop.Recommendation.ListRecommendationsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<hipstershop.Recommendation.ListRecommendationsRequest,
      hipstershop.Recommendation.ListRecommendationsResponse> getListRecommendationsMethod() {
    io.grpc.MethodDescriptor<hipstershop.Recommendation.ListRecommendationsRequest, hipstershop.Recommendation.ListRecommendationsResponse> getListRecommendationsMethod;
      ...
      synchronized (RecommendationServiceGrpc.class) {
        if ((getListRecommendationsMethod = RecommendationServiceGrpc.getListRecommendationsMethod) == null) {
          RecommendationServiceGrpc.getListRecommendationsMethod = getListRecommendationsMethod =
              io.grpc.MethodDescriptor.<hipstershop.Recommendation.ListRecommendationsRequest, hipstershop.Recommendation.ListRecommendationsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ListRecommendations"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  hipstershop.Recommendation.ListRecommendationsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  hipstershop.Recommendation.ListRecommendationsResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void listRecommendations(hipstershop.Recommendation.ListRecommendationsRequest request,
        io.grpc.stub.StreamObserver<hipstershop.Recommendation.ListRecommendationsResponse> responseObserver) {
  ...
  public static final class RecommendationServiceStub
    ...
    /**
     */
    public void listRecommendations(hipstershop.Recommendation.ListRecommendationsRequest request,
        io.grpc.stub.StreamObserver<hipstershop.Recommendation.ListRecommendationsResponse> responseObserver) {
  ...
  public static final class RecommendationServiceBlockingStub
    ...
    /**
     */
    public hipstershop.Recommendation.ListRecommendationsResponse listRecommendations(hipstershop.Recommendation.ListRecommendationsRequest request) {
  ...
  public static final class RecommendationServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<hipstershop.Recommendation.ListRecommendationsResponse> listRecommendations(
        hipstershop.Recommendation.ListRecommendationsRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LIST_RECOMMENDATIONS:
          serviceImpl.listRecommendations((hipstershop.Recommendation.ListRecommendationsRequest) request,
              (io.grpc.stub.StreamObserver<hipstershop.Recommendation.ListRecommendationsResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              hipstershop.Recommendation.ListRecommendationsRequest,
              hipstershop.Recommendation.ListRecommendationsResponse>(
  ...
  private static abstract class RecommendationServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return hipstershop.Recommendation.getDescriptor();
    }
