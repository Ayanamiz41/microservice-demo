...
class EmailServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.SendOrderConfirmation = channel.unary_unary(
                ...
                request_serializer=email__pb2.SendOrderConfirmationRequest.SerializeToString,
...
def add_EmailServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendOrderConfirmation': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=email__pb2.SendOrderConfirmationRequest.FromString,
...
class EmailService:
    ...
    def SendOrderConfirmation(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/hipstershop.EmailService/SendOrderConfirmation',
            email__pb2.SendOrderConfirmationRequest.SerializeToString,
