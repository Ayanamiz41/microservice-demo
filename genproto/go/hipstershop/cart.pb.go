...
const file_cart_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"cart.proto\x12\vhipstershop\x1a\n" +
	"demo.proto\"T\n" +
	...
	"\tEmptyCart\x12\x1d.hipstershop.EmptyCartRequest\x1a\x12.hipstershop.Empty\"\x00BAZ?github.com/Ayanamiz41/microservice-demo/genproto/go/hipstershopb\x06proto3"
...
var file_cart_proto_goTypes = []any{
	...
	(*CartItem)(nil),         // 3: hipstershop.CartItem
	(*Empty)(nil),            // 4: hipstershop.Empty
	(*Cart)(nil),             // 5: hipstershop.Cart
}
var file_cart_proto_depIdxs = []int32{
	3, // 0: hipstershop.AddItemRequest.item:type_name -> hipstershop.CartItem
	0, // 1: hipstershop.CartService.AddItem:input_type -> hipstershop.AddItemRequest
	2, // 2: hipstershop.CartService.GetCart:input_type -> hipstershop.GetCartRequest
	1, // 3: hipstershop.CartService.EmptyCart:input_type -> hipstershop.EmptyCartRequest
	4, // 4: hipstershop.CartService.AddItem:output_type -> hipstershop.Empty
	5, // 5: hipstershop.CartService.GetCart:output_type -> hipstershop.Cart
	4, // 6: hipstershop.CartService.EmptyCart:output_type -> hipstershop.Empty
