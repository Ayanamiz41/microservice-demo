// Package money implements integer-only money arithmetic over the
// hipstershop.Money protobuf message (units + nanos, no floating point).
// Behavior is identical to the upstream Online Boutique frontend money
// package (and to src/checkoutservice/money).
package money
...
// MultiplySlow is a slow multiplication operation done through adding the
// value to itself n-1 times.
