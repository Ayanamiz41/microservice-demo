...
func TestSum(t *testing.T) {
	...
	tests := []struct {
		...
		{"mixed (larger positive, with borrow)", args{mm(11, 100000000), mm(-2, -9000000)}, mm(9, 91000000), nil},
		{"mixed (larger negative, no borrow)", args{mm(-11, -100000000), mm(2, 100000000)}, mm(-9, 0), nil},
		{"mixed (larger negative, with borrow)", args{mm(-11, -100000000), mm(2, 9000000)}, mm(-9, -91000000), nil},
